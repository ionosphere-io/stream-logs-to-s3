...
ln target/${ARCH}-unknown-linux-gnu/debug/stream-logs-to-s3 stream-logs-to-s3-${VERSION}-amzn2023-${ARCH}-debug && \
ln target/${ARCH}-unknown-linux-gnu/release/stream-logs-to-s3 stream-logs-to-s3-${VERSION}-amzn2023-${ARCH}-release && \
zip -9 stream-logs-to-s3-${VERSION}-amzn2023-${ARCH}.zip stream-logs-to-s3-${VERSION}-amzn2023-${ARCH}-debug stream-logs-to-s3-${VERSION}-amzn2023-${ARCH}-release
